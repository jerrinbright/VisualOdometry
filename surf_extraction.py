...
out = cv2.VideoWriter('/vid/SURF1500.avi', fourcc, 20.0, size)
...
prev_frame = 0
matches = []
filename = "/csv/surf/surf1500.csv"
...
while(cont):
    ...
    cv2.putText(img, "SURF-FPS: " + str(round(fps, 2)) +"Nf="+ str(round(x, 2)), (10, 50), font, 2, (0, 0, 0), 2)
    #print(fps)
